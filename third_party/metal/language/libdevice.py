...
def min(arg0, arg1, _semantic=None):
    ...
    return core.extern_elementwise(
        "", "", [arg0, arg1], {
            (core.dtype("int32"), core.dtype("int32")): ("__metal_min", core.dtype("int32")),
            (core.dtype("uint32"), core.dtype("uint32")): ("__metal_umin", core.dtype("uint32")),
            (core.dtype("fp32"), core.dtype("fp32")): ("__metal_fmin", core.dtype("fp32")),
            (core.dtype("fp64"), core.dtype("fp64")): ("__metal_fmin", core.dtype("fp64")),
        }, is_pure=True, _semantic=_semantic)
...
def max(arg0, arg1, _semantic=None):
    ...
    return core.extern_elementwise(
        "", "", [arg0, arg1], {
            (core.dtype("int32"), core.dtype("int32")): ("__metal_max", core.dtype("int32")),
            (core.dtype("uint32"), core.dtype("uint32")): ("__metal_umax", core.dtype("uint32")),
            (core.dtype("fp32"), core.dtype("fp32")): ("__metal_fmax", core.dtype("fp32")),
            (core.dtype("fp64"), core.dtype("fp64")): ("__metal_fmax", core.dtype("fp64")),
        }, is_pure=True, _semantic=_semantic)
